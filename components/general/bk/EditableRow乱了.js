...
class HintInputContainer extends Component{
    constructor(props) {
        super(props);
        this.result = {};
        this.state = {
            "data" : {value:[{"category":"", "num":"1", "validateState":"unknown"}]}
        };
    }
    componentDidMount(props) {
        var array = [];
        array.push({value:this.props.value, type:this.props.selectorValue||this.props.category||this.props.type, validateState:""});
    ...
    addSub(){
        var data2 = this.state.data;
        data2.value.push({value:"1", type:"", validateState:""});
        this.setState({
            "data" : data2
        });
    }
    ...
    render() {
         ...
         var formGroupList = this.state.data.value.map(function(group, index){
          ...
          return (        
            <Col sm={10}>
                <Col sm={7}>
                    <HintInput {...this.props} />
                </Col>
                <Col sm={2}>
                    <SimpleInput {...this.props}/>
                </Col>
                <Col sm={1} style={{textAlign:"center" ,padding:"5px 0px"}}  {...this.props}  componentClass={ControlLabel}>
                    {button}
                </Col>
            </Col>
          );
    ...
    render() {
        ...
        return (
            <FormGroup bgSize="lg" controlId={this.props.id} style={style}>
                <Title value={this.props.alias||this.props.name} notNull={isNotNull}/>       
                <HintInputContainer {...this.props}/>                              
            </FormGroup>
        );
    }
}
...
//     			flag = false;
//     		else if(data2["value"][index].validateState == "unknown"||data2["value"][index].validateState == ""){
...
//             col0 = this.props.columnNames[0]||"num";
//             col1 = this.props.columnNames[1]||"category";
//     	}
//         for(var i in array){
//             var obj = {};
...
//     }
// }
// class SimpleAddableRow extends SelectAddableRow{
// 	constructor(props) {
//         super(props);
//         this.result = {};
//         this.state = {
...
//     addSub(){
//         var data2 = this.state.data;
//         data2.value.push({category:"", num:"", validateState:"unknown"});
//         this.setState({
//             "data" : data2
//         });
//     }
...
//     addSub(){
//         var data2 = this.state.data;
//         data2.value.push({category:"", num:"1", validateState:"unknown"});
//         this.setState({
//             "data" : data2
//         });
//     }
...
//         }
//         var data2 = this.state.data;
//         data2["value"][index].num = event.target.value;
//         this.validateAndSetState(index, data2);
        
//     }
//     validateAndSetState(index, data2){
//         //console.log(this.refs["hintInput"+index].state.data["value"]);
//         var validateResult = this.validateByValue(data2["value"][index].num);
//         Object.assign(data2["value"][index], validateResult);
//         this.setState({
//             "data" : data2
//         });
...
//         console.log(data2)
//         for(var index in data2["value"]){
//             if(data2["value"][index].validateState == "error"||this.refs["hintInput"+index].state.validateState == "unknown"||this.refs["hintInput"+index].state.validateState == "error"){
//                 flag = false;
//             }
//             else if(data2["value"][index].validateState == "unknown"||data2["value"][index].validateState == ""){
//                 var validateResult = this.validateAndSetState(data2["value"][index]);
...
//     getResult(){
//         var resultList = this.state.data["value"];
//         //console.log( this.state.data["value"]);
        
//         for(var index in resultList){
//            resultList[index].category=this.refs["hintInput"+index].state.data["value"];
//            delete resultList[index].validateState;
//            delete resultList[index].type;
//            delete resultList[index].value;
//            delete resultList[index].errorMessage;
//         }
        
//         return {"zuyuan":resultList};
//     }
//     render() {
//         if(this.state.data){
//             var type = this.props.type;
...
//                          <HintInput ref={"hintInput"+index}/>
//                          <HelpBlock>{group.errorMessage0}</HelpBlock>
//                       </Col> 
//                       <Col sm={4}>
//                         <FormControl style={{textAlign:"left",marginTop:"5px"}} defaultValue={group.num} type="text" onChange={that.changeValue.bind(that,index)}>
//                         </FormControl>
//                         <HelpBlock>{group.errorMessage}</HelpBlock>
//                         <FormControl.Feedback style={{right:"15px",top:"4px"}}/>
//                       </Col>
...
class HintInput extends SimpleRow{
    ...
    checkedValueExist(){
        ...
        //console.log(typeof(data2.value)); 
        console.log(data2.value);   
        var selectedWord=data2.value;
        var isContainer = false; 
          for (var i = 0; i < initWords.length; i++) {           		       
            if (selectedWord==initWords[i] ) {
            	   isContainer = true;
            	   break;                      
            }
        }
    ...
    render() {
        ...
        <div id="hintInput" style={{"position":"relative"}}>
            <FormGroup  bgSize="lg" controlId={this.props.id} style={style} validationState={this.state.data.validateState}>        
              <Col>
                <FormControl {...propsExt} onBlur={this.checkedValueExist.bind(this)} onChange={this.changeValue.bind(this)} onKeyDown={this.handleKeyPress.bind(this)}  >
                </FormControl>
                <HelpBlock style={{"textAlign":"left","fontWeight":"normal","color":"#a94442"}}>{this.state.errorMessage}</HelpBlock>
                <FormControl.Feedback style={{right:"15px",top:"4px"}}/>
              </Col>
            </FormGroup>
              {ul}           
...
export {SimpleRow, SelectGroup,  ComplexRow, HintInput, HintGroupRow,Title};
