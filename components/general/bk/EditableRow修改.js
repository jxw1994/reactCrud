...
class SimpleInputContainer extends SimpleInput{   
     getResult(){
...
class SelectAddableRowContainer extends SimpleInput{   
    addSub(){
        var data2 = this.state.data;
...
//         return (        
//             <Col sm={10}>
//                 <SimpleInput {...this.props}/><SimpleInput {...this.props}/>
//             </Col>
//         );
//     }
// }
...
class SelectAddableRow extends SimpleRow {
    ...
    render() {
	    ...
	    var that = this;
    	return (
	        <FormGroup bgSize="lg" controlId={that.props.id} style={style}>
              <Title value={that.props.alias||that.props.name} notNull={isNotNull}/>   
		      <SelectAddableRowContainer  {...that.props}/>
		    </FormGroup>
        );		  
	}	    
}
...
export {SimpleRow, SelectAddableRow, TypeValuePairRow, SelectGroup, CityValuePairRow, ComplexRow, HintInput, HintGroupRow, SelectAddHintRow,SimpleAddableRow,Title};
